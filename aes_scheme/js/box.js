var clientId = '0bisvdff7xcye131w6po9oi7b533duxv';
var clientsecret = '9oHaVTJtxHx29us5nTbFf64ALODL5Tpg';
var redirectUri = 'https://fmkhlbnajaepeekaidomcgehclgbhfgp.chromiumapp.org/main.html';

// var THIRD_SERVER = "http://119.9.73.72/"
...
function firstTimeSetup(){
    if (typeof(rsaList) != "undefined")
        return rsaList;

    // chrome.storage.local.get(['rsaList'], function(result) {
    //     if (typeof(result) !== "undefined" && result != null){
    //         console.log("Get rsaList from local storage");
    //         rsaList = result;
    //         dfdRsa.resolve();
    //         return;
    //     }
    ...
    var url = THIRD_SERVER + 'aes_get_rsa_list';
    var args = {
        url: url,
        crossDomain: true,
        crossOrigin: true,
        ...
        success: function (data){
            rsaList=data;
            dfdRsa.resolve();
            chrome.storage.local.set({rsaList: rsaList});
        }
    };
    $.ajax(args);
}
